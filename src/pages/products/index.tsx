...
export function ProductListPage(props: ProductListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getProducts({
        relations: ['account', 'classification.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('account', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('classification', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'classification',
          header: 'Classification',
          accessorKey: 'classification',
          cell: ({ row: { original: record } }: any) => record?._count?.classification,
        }
      : null,
